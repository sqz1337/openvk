...
ALTER TABLE `ai_bots`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `ai_bots_user_id` (`user_id`),
  ADD KEY `ai_bots_enabled_idx` (`is_enabled`,`last_run_at`);

ALTER TABLE `ai_bot_action_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ai_bot_action_logs_bot_id_idx` (`bot_id`,`created_at`);
